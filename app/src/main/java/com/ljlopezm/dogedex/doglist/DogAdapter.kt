...
import com.ljlopezm.dogedex.databinding.DogListItemBinding

class DogAdapter : ListAdapter<Dog, DogAdapter.DogViewHolder>(DiffCallbock) {

    companion object DiffCallbock: DiffUtil.ItemCallback<Dog>() {
